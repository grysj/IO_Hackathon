...
export default function UsosScreen() {
    ...
    const handleUpload = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch("http://34.116.250.33:8080/api/classes/import_usos", {
                method: "POST",
                headers: {
    ...
    return (
        ...
        >
            <View style={styles.innerContainer}>
                ...
                <TouchableOpacity style={styles.button} onPress={handleUpload} disabled={isLoading}>
                    <Text style={styles.buttonText}>{isLoading ? "Uploading..." : "Upload"}</Text>
                </TouchableOpacity>
            </View>
        </KeyboardAvoidingView>
    );
